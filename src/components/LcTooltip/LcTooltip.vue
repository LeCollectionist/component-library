...
<template>
  <div class="lc_tooltip" :class="[
    ...
    <div v-if="show && $slots.text" :class="tooltipClass" data-testid="tooltip">
      <slot name="text" />
      <LcIcon v-if="clickable" class="lc_tooltip-icon" data-testid="tooltip__close" name="close"
        @click.stop="toggleTooltip" />
    </div>
  </div>
</template>
